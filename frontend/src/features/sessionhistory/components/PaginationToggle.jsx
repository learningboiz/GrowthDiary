    ...
    return (
        <nav className="flex items-center gap-x-1">
            <button
                ...
                className="min-h-[38px] min-w-[38px] py-2 px-2.5 inline-flex justify-center items-center gap-x-2 text-sm rounded-lg text-indigo-600 hover:bg-gray-100 focus:outline-none focus:bg-gray-100">
            ...
            <div className="flex items-center gap-x-1">
                <span className="min-h-[38px] min-w-[38px] flex justify-center items-center border border-indigo-600 text-indigo-500 py-2 px-3 text-sm rounded-lg focus:outline-none focus:bg-gray-50">{pageUserIsOn}</span>
                <span className="min-h-[38px] flex justify-center items-center text-indigo-500 py-2 px-1.5 text-sm">of</span>
                <span className="min-h-[38px] flex justify-center items-center text-indigo-500 py-2 px-1.5 text-sm">{totalPages}</span>
            </div>
            <button
                type="button"
