...
export default function WeeklySummaryTable({weeklySummary}) {
    ...
    const {hours, minutes} = splitDurationIntoHoursMinutes(weeklySummary.totalDuration);
                    ...
                    <div className="border rounded-lg shadow overflow-hidden">
                        <table className="min-w-full divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <th scope="col" className="px-6 py-3 text-start text-xs font-medium text-neutral-50 uppercase">Average Productivity</th>
                            </tr>
                            </thead>
                            <tbody className="divide-y divide-gray-200">
                            <tr>
                                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800">{weeklySummary.topTopic}</td>
                                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800">{hours} hours {minutes} minutes</td>
